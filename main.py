...
def search():
	...
	try:
		...
		messagebox.showerror("Invalide","Invalide registration number!! ")
...
#top frame 
Label (root,text="Email:nehadeore43@gmail.com",width=10,height=3,bg="#f0687c",anchor='e').pack(side=TOP,fill=X)
...
f_entry=Entry(obj2,textvariable=Father_Occupation,width=20,font="arial 10")
